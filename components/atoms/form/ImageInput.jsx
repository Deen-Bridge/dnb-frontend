    ...
    return (
        <div className="">
            ...
            <button
                ...
                className="w-full rounded-[66px] outline-1 outline-accent border-accent border p-1 bg-surface-raised flex items-center justify-between cursor-pointer"
            >
                <div className="flex gap-2 items-center">
                    <i className="bg-accent/10 w-10 h-10 p-2 flex items-center justify-center rounded-[27px] border-wmt-line-gray border text-ink-muted">
                        {/* SVG icon */}
                        <svg
                ...
                <div className="bg-accent/10 py-[6px] px-3 rounded-[83px] flex gap-2 items-center text-accent">
                    <i>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
