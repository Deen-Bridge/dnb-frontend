  ...
  return (
    (<div
      ...
      <div
        ...
        className={cn(
          // Logical inset (start/end) so a `side="left"` sidebar anchors to the
          // inline-start edge — which mirrors to the right automatically under
          // dir="rtl" (Arabic), no separate `side` prop needed.
...
function SidebarSeparator({
  ...
  return (
    (<Separator
      ...
      className={cn("bg-accent mx-2 w-auto", className)}
      {...props} />)
  );
}
