          ...
          <form onSubmit={handleApplySearch} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                >
                  <SelectTrigger id="filter-status" className="h-9 text-sm" aria-label="Filter by status">
              ...
              {/* Item Type Filter */}
              <div className="space-y-1.5">
                <label htmlFor="filter-item-type" className="text-xs font-medium text-muted-foreground">
                  Item Type
                </label>
                <Select
                ...
                >
                  <SelectTrigger id="filter-item-type" className="h-9 text-sm" aria-label="Filter by item type">
