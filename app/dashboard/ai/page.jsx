            ...
            <div className="flex flex-col">
                <header className="sticky top-0 z-10 flex h-[57px] justify-between items-center gap-1 border-b bg-background px-4">
                    <div className="flex flex-col my-2">
                        <h1 className="text-3xl font-semibold bg-gradient-to-r from-green-400 via-green-500 to-green-600 text-transparent bg-clip-text">Deen Bridge AI</h1>
                ...
                <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-3">
                            ...
                            <fieldset className="grid gap-6 rounded-lg border p-4 overflow-auto overscroll-y-auto">
                                ...
                                <fieldset className="grid gap-6 rounded-lg border p-4 overflow-auto overscroll-y-auto">
                                    ...
                                    <div className="grid gap-3">
                                        ...
                                        <span className="text-sm ">How to memorize the only Qur;an</span>
                                    </div>
                                    <div className="grid gap-3">
                    ...
                    <div className="relative flex  h-full flex-col rounded-xl bg-muted/50 p-4 lg:col-span-2">
                        <Badge variant="outline" className="absolute right-3 top-3 border-accent">
                            Output
                        </Badge>
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center p-3 pt-0">
                                ...
                                <div>
                                    <Button round type="submit" className="text-sm ml-auto gap-1.5 text-white flex justify-end bg-accent hover:bg-highlight">
                                        Send Message
