  ...
  return (
    <section className="relative py-24 px-4 sm:px-6 bg-gradient-to-br from-green-50 via-white to-green-100/80 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {/* Desktop Mind Map */}
        <div className="hidden lg:block relative w-full h-[800px] mb-16">
          {/* Central Hub */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
            <div className="w-48 h-48 rounded-full bg-gradient-to-br from-accent via-green-500 to-highlight flex items-center justify-center shadow-2xl animate-pulse">
              <div className="text-center">
                <span className="text-white text-3xl font-bold block">Deen</span>
                <span className="text-white text-3xl font-bold block">Bridge</span>
              </div>
            </div>
          </div>

          {/* Animated Connection Lines */}
          <svg className="absolute inset-0 w-full h-full z-10" viewBox="0 0 1200 800">
            {/* Top to Right */}
            <line x1="600" y1="400" x2="900" y2="200" stroke="#22c55e" strokeWidth="3" strokeDasharray="10,5" className="animate-pulse">
              <animate attributeName="stroke-dashoffset" values="0;20;0" dur="2s" repeatCount="indefinite" />
            </line>
            {/* Right to Bottom Right */}
            <line x1="900" y1="200" x2="900" y2="500" stroke="#22c55e" strokeWidth="3" />
            {/* Bottom Right to Bottom */}
            <line x1="900" y1="500" x2="600" y2="700" stroke="#22c55e" strokeWidth="3" strokeDasharray="10,5">
              <animate attributeName="stroke-dashoffset" values="0;20;0" dur="2s" repeatCount="indefinite" />
            </line>
            {/* Bottom to Bottom Left */}
            <line x1="600" y1="700" x2="300" y2="500" stroke="#22c55e" strokeWidth="3" />
            {/* Bottom Left to Top Left */}
            <line x1="300" y1="500" x2="300" y2="200" stroke="#22c55e" strokeWidth="3" strokeDasharray="10,5">
              <animate attributeName="stroke-dashoffset" values="0;20;0" dur="2s" repeatCount="indefinite" />
            </line>
            {/* Top Left to Top */}
            <line x1="300" y1="200" x2="600" y2="100" stroke="#22c55e" strokeWidth="3" />
          </svg>
          ...
          {steps.map((step, index) => (
            ...
            >
              <div className="bg-white/95 backdrop-blur-xl rounded-3xl p-6 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-110 border border-white/20 group animate-fade-in-up">
                <div className="flex flex-col items-center text-center">
                  {/* Step Number */}
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-accent to-highlight flex items-center justify-center shadow-lg mb-4 group-hover:scale-110 transition-transform">
                    <span className="text-white font-bold text-lg">{step.id}</span>
                  </div>
                  
                  {/* Icon */}
                  <div className={cn(
                    "w-20 h-20 rounded-2xl bg-gradient-to-r flex items-center justify-center shadow-lg mb-4 group-hover:scale-110 transition-transform duration-300",
                    step.color
                  )}>
                    {step.icon}
                  </div>
                  ...
                  {/* Content */}
                  <h3 className="text-xl font-bold text-accent mb-3 font-stretch-125%">
                    {step.title}
                  </h3>
                  <p className="text-gray-600 text-sm leading-relaxed font-stretch-110%">
                    {step.desc}
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      <h3 className="text-xl font-bold text-accent font-stretch-125%">
                        {step.title}
                      </h3>
