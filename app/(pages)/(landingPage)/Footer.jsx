import { FaFacebookF, FaTwitter, FaLinkedinIn, FaLongArrowAltRight } from 'react-icons/fa';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 gap-y-6 mb-12">
                    ...
                    <div>
                        ...
                        <p className="text-gray-200 text-sm leading-relaxed">
                            lbewjbehfjkvfe fnbje hj ejh jda fehvhsf fdjvhjrv hdjlsvhlvf                             lbewjbehfjkvfe fnbje hj ejh jda fehvhsf fdjvhjrv hdjlsvhlvf sjvhjvrenfhkbliub;eoqnw hurhwbeiuth jwkrbjibierwb;j fdjbirewb k beiefb jk wrvf;wrgtiygwrtjkhv iusvb rbilrvsbiiul
                            sjvhjvrenfhkbliub;eoqnw hurhwbeiuth jwkrbjibierwb;j fdjb                            lbewjbehfjkvfe fnbje hj ejh jda fehvhsf fdjvhjrv hdjlsvhlvf sjvhjvrenfhkbliub;eoqnw hurhwbeiuth jwkrbjibierwb;j fdjbirewb k beiefb jk wrvf;wrgtiygwrtjkhv iusvb rbilrvsbiiul
                            irewb k beiefb jk wrvf;wrgtiygwrtjkhv iusvb rbilrvsbiiul
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4 text-2xl  justify-start hover:text-green-600">
                            <Link href="#" className="hover:bg-slate-200 rounded-full p-2 sm:p-6 ">
