      ...
      <div className="relative z-10 max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {missionPoints.map((point, idx) => (
            <div 
              key={idx} 
              className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-accent/10 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
            >
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 flex items-center justify-center mx-auto mb-6 shadow-sm border border-accent/5">
                {point.icon}
              </div>
